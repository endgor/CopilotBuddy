...
namespace PallyPilot.GUI
{
    ...
    internal static class Theme
    {
        ...
        public static readonly Color Accent      = Color.FromArgb(245, 140, 186);  // paladin pink
        ...
        {
            // FlatStyle.Standard renders the native checkbox (white box + dark check) clearly; a Flat
            // checkbox on a dark panel is near-invisible (its box shares the dark BackColor).
